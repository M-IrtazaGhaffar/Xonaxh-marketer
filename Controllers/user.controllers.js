const StockModel = require("../Model/men/stock.model.js");
const appealModel = require("../Model/appeal/appeal.model.js");
const contactModel = require("../Model/contact/contact.model.js");
const notificationsModel = require("../Model/notifications/notifications.model.js");
const orderModel = require("../Model/men/order.model.js");
const reportModel = require("../Model/report/report.model.js");
...
const login = async (req, res) => {
  try {
    ...
    if (findUser.length !== 0) {
      const result = true;
      await bcrypt.compare(password, findUser[0].password).then();
      if (result) {
...
const stock = async (req, res) => {
  try {
    const stock = await StockModel.find(
      {},
      { desc: 0, name: 0, quantity: 0, price: 0, marketerpayment: 0 }
    ).sort({ date: -1 });
